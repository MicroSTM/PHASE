...
for env in envs:
    ...
    # weak agent with item, other not
    colab1_rm = goal_item_rm
    ...
    strengths["agent" + str(colab1_id)].append(random.choice(low_strength))
    strengths["agent" + str(colab2_id)].append(random.choice(high_strength))
    # random
